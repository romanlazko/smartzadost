...
class Child extends Model
{
    ...
    {
        return $this->hasOne(ChildAddress::class, 'child_id', 'id');
    }

    public function passport()
    {
        return $this->hasOne(ChildPassport::class, 'child_id', 'id');
    }

    public function occupation()
    {
        return $this->hasOne(ChildOccupation::class, 'child_id', 'id');
    }
}
